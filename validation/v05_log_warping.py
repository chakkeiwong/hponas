...
from validators.base_validator import ValidationProtocol, AuditCheck, AuditReport
...
def run_search(
    ...
    for trial in range(n_trials):
        ...
        # Extract learning_rate value from Config
        value = objective(config.values)
...
def v05_log_warping_effectiveness(
    ...
    space_log = SearchSpace(parameters={
    ...
    space_linear = SearchSpace(parameters={
        "learning_rate": Parameter(
            name="learning_rate",
            type=ParameterType.CONTINUOUS,
            bounds=(1e-5, 1e-2),
